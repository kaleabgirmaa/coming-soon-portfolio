...
function Head() {
  return (
    <head>
      <title>Kaleab Deriba</title>
      <link rel="icon" href="/static/favicon.png" />
      <link rel="stylesheet" href="/static/app.css" />
      <meta name="viewport" content="width=device-width, initial-scale=1" />
      <meta
        name="description"
        content="Hi, I'm Kaleab Deriba, I'm soon to become a developer"
      />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:site" content="@ancient5oul" />
      <meta name="twitter:creator" content="@ancient5oul" />
      <meta name="twitter:title" content="Kaleab Deriba" />
      <meta
        name="twitter:description"
        content="Hi I'm Kaleab Deriba"
      />
...
function Footer() {
  return (
    <footer>
      ...
      <a
        target="_blank"
        href="https://github.com/kaleabgirmaa"
        className="source"
      >
        <svg
          width="24"
      ...
      <a
        target="_blank"
        href="https://www.linkedin.com/in/kaleabgirmaa/"
        className="source"
      >
